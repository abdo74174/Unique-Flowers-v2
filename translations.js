const translations = {
    en: {
        ...
        product: {
            ...
            signature: "Signature",
            grand: "Grand",
            include_card: "Include Hand-written Card (+)",
    ...
    ar: {
        ...
        product: {
            ...
            art_desc: "كل تنسيق هو قطعة فريدة من الفن الحي. نحن لا نضع الزهور فحسب، بل نؤلف القصص. هذا التنسيق مستوحى من ضوء الفجر الأول الذي يضرب حديقة مغطاة بالندى في أوائل يونيو.",
        ...
        catalog_page: {
            ...
            women: "نساء",
            newborns: "مواليد",
            p1_title: "بيوني المتوارثة",
            p1_type: "تنسيق طازج",
            p2_title: "نحت المرمر",
            p2_type: "فازة مصنوعة يدوياً",
            p3_title: "أوركيد منتصف الليل",
            p3_type: "زهور فاخرة",
            p4_title: "توسكان المجففة",
...
function applyTranslations(lang) {
    ...
    // Apply font settings via style block
    ...
    // Update active language toggle state
...
document.addEventListener('DOMContentLoaded', () => {
    // Default to 'ar' if no language is saved
